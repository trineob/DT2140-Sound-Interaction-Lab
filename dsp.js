...
/*
Code generated with Faust version 2.68.1
Compilation options: -lang wasm -ct 1 -cn drop -es 1 -mcd 16 -single -ftz 2 
*/ 

// function getJSONdrop() {
// return '{"name": "drop","filename": "drop.dsp","version": "2.68.1","compile_options": "-lang wasm -ct 1 -cn drop -es 1 -mcd 16 -single -ftz 2","library_list": ["/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/stdfaust.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/demos.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/reverbs.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/maths.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/platform.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/filters.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/delays.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/oscillators.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/basics.lib","/opt/homebrew/Cellar/faust/2.68.1_1/share/faust/signals.lib"],"include_pathnames": ["/opt/homebrew/Cellar/faust/2.68.1_1/share/faust","/usr/local/share/faust","/usr/share/faust",".","/Users/enkatsu/Documents/Projects/p5js-faust-example"],"size": 848364,"inputs": 0,"outputs": 2,"meta": [ { "basics.lib/name": "Faust Basic Element Library" },{ "basics.lib/tabulateNd": "Copyright (C) 2023 Bart Brouns <bart@magnetophon.nl>" },{ "basics.lib/version": "1.11.1" },{ "compile_options": "-lang wasm -ct 1 -cn drop -es 1 -mcd 16 -single -ftz 2" },{ "delays.lib/name": "Faust Delay Library" },{ "delays.lib/version": "1.1.0" },{ "demos.lib/freeverb_demo:author": " Romain Michon" },{ "demos.lib/freeverb_demo:licence": "LGPL" },{ "demos.lib/name": "Faust Demos Library" },{ "demos.lib/version": "1.1.0" },{ "filename": "drop.dsp" },{ "filters.lib/allpass_comb:author": "Julius O. Smith III" },{ "filters.lib/allpass_comb:copyright": "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>" },{ "filters.lib/allpass_comb:license": "MIT-style STK-4.3 license" },{ "filters.lib/lowpass0_highpass1": "MIT-style STK-4.3 license" },{ "filters.lib/name": "Faust Filters Library" },{ "filters.lib/version": "1.3.0" },{ "maths.lib/author": "GRAME" },{ "maths.lib/copyright": "GRAME" },{ "maths.lib/license": "LGPL with exception" },{ "maths.lib/name": "Faust Math Library" },{ "maths.lib/version": "2.6.0" },{ "name": "drop" },{ "oscillators.lib/name": "Faust Oscillator Library" },{ "oscillators.lib/version": "1.4.0" },{ "platform.lib/name": "Generic Platform Library" },{ "platform.lib/version": "1.3.0" },{ "reverbs.lib/mono_freeverb:author": "Romain Michon" },{ "reverbs.lib/name": "Faust Reverb Library" },{ "reverbs.lib/stereo_freeverb:author": "Romain Michon" },{ "reverbs.lib/version": "1.2.0" },{ "signals.lib/name": "Faust Signal Routing Library" },{ "signals.lib/version": "1.3.0" }],"ui": [ {"type": "vgroup","label": "drop","items": [ {"type": "hgroup","label": "Freeverb","items": [ {"type": "vgroup","label": "0x00","meta": [{ "0": "" }],"items": [ {"type": "vslider","label": "Damp","shortname": "Damp","address": "/drop/Freeverb/0x00/Damp","index": 262220,"meta": [{ "0": "" },{ "style": "knob" },{ "tooltip": "Somehow control the         density of the reverb." }],"init": 0.5,"min": 0,"max": 1,"step": 0.025},{"type": "vslider","label": "RoomSize","shortname": "RoomSize","address": "/drop/Freeverb/0x00/RoomSize","index": 262212,"meta": [{ "1": "" },{ "style": "knob" },{ "tooltip": "The room size         between 0 and 1 with 1 for the largest room." }],"init": 0.5,"min": 0,"max": 1,"step": 0.025},{"type": "vslider","label": "Stereo Spread","shortname": "Stereo_Spread","address": "/drop/Freeverb/0x00/Stereo_Spread","index": 586048,"meta": [{ "2": "" },{ "style": "knob" },{ "tooltip": "Spatial         spread between 0 and 1 with 1 for maximum spread." }],"init": 0.5,"min": 0,"max": 1,"step": 0.01}]},{"type": "vslider","label": "Wet","shortname": "Wet","address": "/drop/Freeverb/Wet","index": 262152,"meta": [{ "1": "" },{ "tooltip": "The amount of reverb applied to the signal         between 0 and 1 with 1 for the maximum amount of reverb." }],"init": 0.3333,"min": 0,"max": 1,"step": 0.025}]},{"type": "button","label": "drop","shortname": "drop","address": "/drop/drop","index": 262168},{"type": "vgroup","label": "freq","items": [ {"type": "hslider","label": "0x00","shortname": "freq","address": "/drop/freq/0x00","index": 262164,"init": 600,"min": 150,"max": 2000,"step": 1}]}]}]}';
// }
/*
 faust2webaudio
...
// Usage : drop.createDSP(audioCtx, 1024).then(dsp => dsp.connect(audioCtx.destination));
